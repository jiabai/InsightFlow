...
class QuestionGenerator:
    ...
    Attributes:
        ...
        db_manager: InsightRepository instance for database operations
    """
    def __init__(self, llm_config: dict, db_manager: InsightRepository, is_mock: bool=True):
    ...
    async def _label_and_save_questions(
        ...
        labeled_response = await self.llm_client.get_response_async(label_prompt)
