...
async function enableImmersiveMode(content) {
    ...
    // console.log('要展示的文本内容:', mainContentElement.textContent);
...
function createImmersiveContainer(mainContent) {
    ...
    // console.log('克隆内容结构:', clonedContent);
    // console.log('克隆内容文本:', clonedContent.textContent);
