...
export function setupQuestionSidebar(contentText: string | undefined): void {
    let questionsContainer: HTMLElement | null = document.getElementById('questions-container');
    if (!questionsContainer) {
        ...
        // 获取或创建侧边栏容器
        let sidebar: HTMLElement | null = document.getElementById('question-sidebar');
        if (!sidebar) {
    ...
    function addStepMessage(message: string): void {
